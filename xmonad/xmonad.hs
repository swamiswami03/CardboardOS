...
clipboardy = spawn "rofi -modi \"\63053 :greenclip print\" -show \"\63053 \" -run-command '{cmd}' -theme ~/.config/rofi/launcher/type1/style-2.rasi"
...
rofi_launcher = spawn "./.config/rofi/launchers/type-1/launcher.sh"
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm,               xK_x ), sendMessage NextLayout)
...
myStartupHook = do
  ...
  spawnOnce "dunst"
  spawnOnce "bash ~/.config/polybar/launch.sh --grayblocks"
...
defaults = def {
      ...
      -- hooks, layouts
        ...
        layoutHook = gaps [(L,15), (R,20), (U,60), (D,10)] $ spacingRaw True (Border 20 20 20 20) True (Border 20 20 20 20) True $ smartBorders $ myLayout,
...
help = unlines ["The default modifier key is 'super'. Default keybindings:",
    ...
    "mod-button2  Raise the window to the top of the stack",
    "mod-button3  Set the window to floating mode and resize by dragging"]
picomPath = "~/.config/picom/picom.conf"
